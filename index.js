...
window.onload = (function($) {
    ...
    const date_string_dom = document.createElement('h1');
    const calender = document.querySelector('.calender__header');;

    date_string_dom.textContent = 'Today ' + date[1] + ' ' + date[2] + ' ' + date[3];
    calender.insertBefore(date_string_dom, calender.firstElementChild);
});
